...
Python is the *de facto* programming language for the Age of AI. It can be applied to traditional tasks such as web development and network analysis. But Python is the essential language for scientific computing, data science, and the cluster of emerging technologies around AI.
...
You might also be interested in the sister Meetups [Data Science for Absolute Beginners](https://www.meetup.com/python-for-absolute-beginners/) and [Machine Learning for Absolute Beginners]
